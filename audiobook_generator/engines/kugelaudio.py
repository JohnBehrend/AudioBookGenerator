...
class KugelAudioEngine(TTSEngine):
    ...
    def _run_worker(cls, request_queue: Queue, response_queue: Queue) -> None:
        ...
        def load_model(device: str, turbo: bool = False) -> None:
        ...
        while True:
            ...
            try:
                ...
                if method == "generate_voice_sample":
                    ...
                    inputs = processor(text=sample_text, padding=True, return_tensors="pt")
                    ...
                    inputs = processor(text=text, voice_prompt=voice_path, padding=True, return_tensors="pt")
